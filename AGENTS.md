...
- This sync branch starts from the original repository's `main` at `4b5bf7e1be7b75c7074ba105ae12099de8ece813` and imports the reviewed local changes without replacing history. Before claiming completion, return the commit SHA, changed paths, commands with exit codes, relevant test/build evidence, artifact hashes and unresolved risks.
